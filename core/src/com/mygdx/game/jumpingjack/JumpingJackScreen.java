...
public class JumpingJackScreen extends BaseScreen {
	...
	public JumpingJackScreen(BaseGame g) {
		super(g);
	}
	...
	public void create() {
		...
		player = new Player();
		Animation walkAnim = GameUtils.parseImageFiles("jumpingjack/walk-", ".png", 3, 0.15f, Animation.PlayMode.LOOP_PINGPONG);
	...
	public boolean keyDown(int keycode){
		if (keycode == Keys.P)
			togglePaused();
		if (keycode == Keys.R)
			game.setScreen( new JumpingJackScreen(game) );
